...
describe('Function checkFormatDate', () => {
    it('has exactly 1 parameters', () => {
        try {
            ...
            expect(checkFormatDate('01.10.2020', '02.10.2020')).toThrow(NumOfVariablesException);
...
describe('Function getDateFromString', () => {
    it('has exactly 1 parameters', () => {
        try {
            ...
            expect(getDateFromString('01.10.2020', '02.10.2020')).toThrow(NumOfVariablesException);
        } catch (err) { errMsg(err); }
    });
...
describe('Function getLatest', () => {
    ...
    it('has exactly 2 parameters', () => {
        try {
            ...
            expect(getLatest('01.10.2020', '10.10.2020', '15.10.2020'))
